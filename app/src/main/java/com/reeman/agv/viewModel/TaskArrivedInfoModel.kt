...
class TaskArrivedInfoModel private constructor(
    ...
    val isReturnToChargePoint:Boolean,
) : Parcelable {
    ...
    class Builder(private var taskMode: String = "") {
        ...
        private var isReturnToChargePoint:Boolean = false
        ...
        fun setIsReturnToChargePoint(isReturnToChargePoint: Boolean)=
            apply { this.isReturnToChargePoint = isReturnToChargePoint }
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeByte(if (isReturnToChargePoint)1 else 0)
    }
